...
pub struct Bautizado {
    ...
    pub bau_cedula: Option<String>,
    pub bau_fecha_nac: Option<String>,
    pub bau_lugar_nac: Option<String>,
    pub bau_min_bau: i32,
    pub bau_padre: Option<String>,
    pub bau_madre: Option<String>,
    pub bau_padrinos: Option<String>,
    pub bau_min_cert: i32,
    pub bau_fecha_bau: String,
    pub bau_tomo: Option<i32>,
    pub bau_pag: Option<i32>,
    pub bau_num: Option<i32>,
    pub bau_fecha_acta: Option<String>,
    pub bau_anio_acta: Option<i32>,
